...
namespace Glest {
	namespace Game {
		...
		MenuStateMods::MenuStateMods(Program * program,
			...
			//create
			techInfoXPos = 5;
			keyTechScrollBarTitle1.registerGraphicComponent(containerName,
				"keyTechScrollBarTitle1");
			keyTechScrollBarTitle1.init(techInfoXPos + 5, scrollListsYPos + 30,
				labelWidth, 20);
			keyTechScrollBarTitle1.setText(lang.getString("TechTitle1"));
			keyTechScrollBarTitle1.setFont(CoreData::getInstance().
				getMenuFontBig());
			keyTechScrollBarTitle1.setFont3D(CoreData::getInstance().
				getMenuFontBig3D());
			keyTechScrollBarTitle2.registerGraphicComponent(containerName,
				"keyTechScrollBarTitle2");
			keyTechScrollBarTitle2.init(techInfoXPos - 10 + keyButtonsWidthTech,
				scrollListsYPos + 17, labelWidth, 20);
			keyTechScrollBarTitle2.setText(lang.getString("TechTitle2"));
			keyTechScrollBarTitle2.setFont(CoreData::getInstance().
				getMenuFontNormal());
			keyTechScrollBarTitle2.setFont3D(CoreData::getInstance().
				getMenuFontNormal3D());

			mapInfoXPos = 260;
			keyMapScrollBarTitle1.registerGraphicComponent(containerName,
				"keyMapScrollBarTitle1");
			keyMapScrollBarTitle1.init(mapInfoXPos + 5, scrollListsYPos + 30,
				labelWidth, 20);
			keyMapScrollBarTitle1.setText(lang.getString("MapTitle1"));
			keyMapScrollBarTitle1.setFont(CoreData::getInstance().
				getMenuFontBig());
			keyMapScrollBarTitle1.setFont3D(CoreData::getInstance().
				getMenuFontBig3D());
			keyMapScrollBarTitle2.registerGraphicComponent(containerName,
				"keyMapScrollBarTitle2");
			keyMapScrollBarTitle2.init(mapInfoXPos - 10 + keyButtonsWidthMap,
				scrollListsYPos + 17, labelWidth, 20);
			keyMapScrollBarTitle2.setText(lang.getString("MapTitle2"));
			keyMapScrollBarTitle2.setFont(CoreData::getInstance().
				getMenuFontNormal());
			keyMapScrollBarTitle2.setFont3D(CoreData::getInstance().
				getMenuFontNormal3D());

			tilesetInfoXPos = 530;
			keyTilesetScrollBarTitle1.registerGraphicComponent(containerName,
				"keyTilesetScrollBarTitle1");
			keyTilesetScrollBarTitle1.init(tilesetInfoXPos + 5,
				scrollListsYPos + 30, labelWidth, 20);
			keyTilesetScrollBarTitle1.setText(lang.getString("TilesetTitle1"));
			keyTilesetScrollBarTitle1.setFont(CoreData::getInstance().
				getMenuFontBig());
			keyTilesetScrollBarTitle1.setFont3D(CoreData::getInstance().
				getMenuFontBig3D());


			scenarioInfoXPos = 755;
			keyScenarioScrollBarTitle1.registerGraphicComponent(containerName,
				"keyScenarioScrollBarTitle1");
			keyScenarioScrollBarTitle1.init(scenarioInfoXPos, scrollListsYPos + 30,
				labelWidth, 20);
			keyScenarioScrollBarTitle1.setText(lang.getString("ScenarioTitle1"));
			keyScenarioScrollBarTitle1.setFont(CoreData::getInstance().
				getMenuFontBig());
			keyScenarioScrollBarTitle1.setFont3D(CoreData::getInstance().
				getMenuFontBig3D());

			mainMessageBoxState = ftpmsg_None;
			mainMessageBox.registerGraphicComponent(containerName,
				"mainMessageBox");
			...
			lineVertical.init(500, returnLineY, 5,
				installButtonYPos - 60 - returnLineY);
			...
			pleaseWaitLabel.registerGraphicComponent(containerName,
				"pleaseWaitLabel");
			...
			pleaseWaitLabel.setFont3D(CoreData::getInstance().
				getMenuFontBig3D());
			...
			lineVerticalReturn.init(buttonReturn.getX() - 10, returnLineY - 80, 5,
				81);
			...
			buttonInstalled.registerGraphicComponent(containerName,
				"buttonInstalled");
			...
			keyTilesetScrollBar.init(tilesetInfoXPos + keyButtonsWidthTil,
				scrollListsYPos - listBoxLength +
				keyButtonsLineHeight, false, 200, 20);
			...
			keyTechScrollBar.init(techInfoXPos + keyButtonsWidthTech + labelWidth +
				20,
				scrollListsYPos - listBoxLength +
				keyButtonsLineHeight, false, 200, 20);
			...
			keyMapScrollBar.init(mapInfoXPos + keyButtonsWidthMap + labelWidth +
				20,
				scrollListsYPos - listBoxLength +
				keyButtonsLineHeight, false, 200, 20);
			...
			keyScenarioScrollBar.init(scenarioInfoXPos + keyButtonsWidthScen,
				scrollListsYPos - listBoxLength +
				keyButtonsLineHeight, false, 200, 20);
		...
		void MenuStateMods::simpleTask(BaseThread * callingThread,
			...
			MutexSafeWrapper safeMutexThreadOwner(callingThread->
				getMutexThreadOwnerValid(),
				mutexOwnerId);
			...
			int expectedResult =
				config.getInt("FileArchiveExtractCommandSuccessResult", "0");
			bool findArchive =
				executeShellCommand(fileArchiveExtractCommand, expectedResult);
			if (findArchive == false) {
				mainMessageBoxState = ftpmsg_None;
				mainMessageBox.init(lang.getString("Ok"), 450);
				showMessageBox(lang.getString("ModRequires7z"),
					lang.getString("Notice"), true);
			}
			...
			if (config.getString("Masterserver", "") != "") {
				...
				techsMetaData =
					SystemFlags::getHTTP(baseURL + "showTechsForGlest.php" +
						phpVersionParam + gameVersion + playerUUID,
						handle, -1, &curlResult);
				if (SystemFlags::VERBOSE_MODE_ENABLED)
				...
				if (curlResult != CURLE_OK) {
					...
					char szBuf[8096] = "";
					snprintf(szBuf, 8096,
						lang.getString("ModErrorGettingServerData").c_str(),
						curlError.c_str());
				...
				if (curlResult == CURLE_OK ||
					...
					tilesetsMetaData =
						SystemFlags::getHTTP(baseURL + "showTilesetsForGlest.php" +
							phpVersionParam + gameVersion, handle, -1,
							&curlResult);
					if (SystemFlags::VERBOSE_MODE_ENABLED)
					...
					mapsMetaData =
						SystemFlags::getHTTP(baseURL + "showMapsForGlest.php" +
							phpVersionParam + gameVersion, handle, -1,
							&curlResult);
					if (SystemFlags::VERBOSE_MODE_ENABLED)
						printf("mapsMetaData [%s]\n", mapsMetaData.c_str());
					...
					scenariosMetaData =
						SystemFlags::getHTTP(baseURL + "showScenariosForGlest.php" +
							phpVersionParam + gameVersion, handle, -1,
							&curlResult);
					if (SystemFlags::VERBOSE_MODE_ENABLED)
						printf("scenariosMetaData [%s]\n", scenariosMetaData.c_str());
			...
			for (unsigned int i = 0; i < tilesetListRemote.size(); i++) {
				...
				if (result != "") {
					...
					button->init(tilesetInfoXPos, keyButtonsYBase, keyButtonsWidthTil,
						keyButtonsHeight);
					button->setText(modinfo.name);
					button->setUseCustomTexture(true);
					button->setCustomTexture(CoreData::getInstance().
						getCustomTexture());
			...
			for (unsigned int i = 0; i < tilesetFilesUserData.size(); i++) {
				...
				bool alreadyHasTileset =
					(tilesetCacheList.find(tilesetName) != tilesetCacheList.end());
			...
			for (unsigned int i = 0; i < techListRemote.size(); i++) {
				...
				if (result != "") {
					...
					GraphicButton *button = new GraphicButton();
					button->init(techInfoXPos, keyButtonsYBase, keyButtonsWidthTech,
						keyButtonsHeight);
					button->setText(modinfo.name);
					button->setUseCustomTexture(true);
					button->setCustomTexture(CoreData::getInstance().
					...
					label->init(techInfoXPos + keyButtonsWidthTech + 10,
						keyButtonsYBase, labelWidth, 20);
			...
			for (unsigned int i = 0; i < techTreeFilesUserData.size(); i++) {
				...
				bool alreadyHasTech =
					(techCacheList.find(techName) != techCacheList.end());
				if (alreadyHasTech == false) {
					vector < string > techPaths = config.getPathListForType(ptTechs);
					string & techPath = techPaths[1];
					endPathWithSlash(techPath);
					vector < string > factions;
					findAll(techPath + techName + "/factions/*.", factions, false,
						false);
			...
			for (unsigned int i = 0; i < mapListRemote.size(); i++) {
				...
				if (result != "") {
					...
					GraphicButton *button = new GraphicButton();
					button->init(mapInfoXPos, keyButtonsYBase, keyButtonsWidthMap,
						keyButtonsHeight);
					button->setText(modinfo.name);
					button->setUseCustomTexture(true);
					button->setCustomTexture(CoreData::getInstance().
					...
					GraphicLabel *label = new GraphicLabel();
					label->init(mapInfoXPos + keyButtonsWidthMap + 10, keyButtonsYBase,
						labelWidth, 20);
					label->setText(modinfo.count);
			...
			for (unsigned int i = 0; i < scenarioListRemote.size(); i++) {
				...
				if (result != "") {
					...
					GraphicButton *button = new GraphicButton();
					button->init(scenarioInfoXPos, keyButtonsYBase,
						keyButtonsWidthScen, keyButtonsHeight);
					button->setText(modinfo.name);
					button->setUseCustomTexture(true);
					button->setCustomTexture(CoreData::getInstance().
						getCustomTexture());
			...
			for (unsigned int i = 0; i < scenarioFilesUserData.size(); i++) {
				...
				bool alreadyHasScenario =
					(scenarioCacheList.find(scenarioName) != scenarioCacheList.end());
		...
		MapInfo MenuStateMods::loadMapInfo(string file) {
			try {
				...
				MapPreview::loadMapInfo(file, &mapInfo,
					lang.getString("MaxPlayers"),
					lang.getString("Size"), true);
			} catch (exception & e) {
		...
		string MenuStateMods::refreshTechModInfo(string techInfo) {
			...
			if (techInfoList.size() >= 6) {
				...
				if (itemPath.empty() == false) {
					...
					uint32 crc =
						getFolderTreeContentsCheckSumRecursively(itemPath, ".xml", NULL,
							forceRefresh);
					if (crc == 0) {
						itemPath =
							config.getPathListForType(ptTechs,
		...
		void MenuStateMods::getMapsLocalList() {
			...
			*/
			...
			mapFilesUserData =
				MapPreview::findAllValidMaps(pathList, scenarioDir, true, false,
					&invalidMapList);
		}
		...
		void MenuStateMods::mouseClick(int x, int y, MouseButton mouseButton) {
			...
			if (buttonReturn.mouseClick(x, y)) {
				...
				if (fileFTPProgressList.empty() == false) {
					...
					char szBuf[8096] = "";
					snprintf(szBuf, 8096,
						lang.getString("ModDownloadInProgressCancelQuestion").
						c_str(), fileFTPProgressList.size());
					...
					if (button == 0) {
						if (mainMessageBoxState == ftpmsg_Quit) {
							...
							if (tilesetPaths.size() > 1) {
								...
								bool remoteHasTileset =
									(tilesetCacheList.find(selectedTilesetName) !=
								...
								if (remoteHasTileset == false) {
									...
									for (unsigned int i = 0; i < keyTilesetButtons.size(); ++i) {
										...
										if (button != NULL
											&& button->getText() == selectedTilesetName) {
											delete button;
											keyTilesetButtons.erase(keyTilesetButtons.begin() +
												i);
											keyTilesetScrollBar.
												setElementCount((int) keyTilesetButtons.size());
											break;
										}
									}
								}
								...
								string pathSearchString =
									string("/") + selectedTilesetName + string("/*");
								const string filterFileExt = ".xml";
								clearFolderTreeContentsCheckSum(paths, pathSearchString,
									filterFileExt);
								clearFolderTreeContentsCheckSumList(paths, pathSearchString,
									filterFileExt);
								safeMutexFTPProgress.ReleaseLock();
							...
							if (getItemAfterRemoval == true) {
								...
								if (ftpClientThread != NULL)
									ftpClientThread->addTilesetToRequests(tilesetName,
										tilesetURL);
								...
								if (ftpClientThread != NULL
									...
									ftpClientThread->getProgressMutex()->
									setOwnerId(mutexOwnerId);
								fileFTPProgressList[tilesetName] =
									pair < int, string >(0, "");
								safeMutexFTPProgress.ReleaseLock();
							...
							if (techPaths.size() > 1) {
								...
								vector < string > paths =
									Config::getInstance().getPathListForType(ptTechs);
								string pathSearchString =
									string("/") + selectedTechName + string("/*");
								const string filterFileExt = ".xml";
								clearFolderTreeContentsCheckSum(paths, pathSearchString,
									filterFileExt);
								clearFolderTreeContentsCheckSumList(paths, pathSearchString,
							...
							if (scenarioPaths.size() > 1) {
								...
								if (remoteHasScenario == false) {
									for (unsigned int i = 0; i < keyScenarioButtons.size();
										++i) {
										GraphicButton *button = keyScenarioButtons[i];
										if (button != NULL
											&& button->getText() == selectedScenarioName) {
											delete button;
											keyScenarioButtons.erase(keyScenarioButtons.begin() +
												i);
											keyScenarioScrollBar.
												setElementCount((int) keyScenarioButtons.size());
											break;
										}
									}
								}
								...
								vector < string > paths =
									Config::getInstance().getPathListForType(ptScenarios);
								string pathSearchString =
									string("/") + selectedScenarioName + string("/*");
								const string filterFileExt = ".xml";
								clearFolderTreeContentsCheckSum(paths, pathSearchString,
									filterFileExt);
								clearFolderTreeContentsCheckSumList(paths, pathSearchString,
							...
							if (getItemAfterRemoval == true) {
								...
								if (ftpClientThread != NULL)
									ftpClientThread->addScenarioToRequests(scenarioName,
										scenarioURL);
								...
								if (ftpClientThread != NULL
									...
									ftpClientThread->getProgressMutex()->
									setOwnerId(mutexOwnerId);
								fileFTPProgressList[scenarioName] =
									pair < int, string >(0, "");
								safeMutexFTPProgress.ReleaseLock();
				...
				if (selectedTechName != "") {
					bool alreadyHasTech =
						(std::
							find(techTreeFiles.begin(), techTreeFiles.end(),
								selectedTechName) != techTreeFiles.end());
					if (alreadyHasTech == true) {
						bool remoteHasTech =
							(techCacheList.find(selectedTechName) != techCacheList.end());
					...
					mainMessageBoxState = ftpmsg_None;
					mainMessageBox.init(lang.getString("Ok"), 450);
					showMessageBox(lang.getString("ModSelectTechToInstall"),
						lang.getString("Notice"), true);
				}
				...
				if (selectedTechName != "") {
					...
					if (alreadyHasTech == true) {
						...
						char szBuf[8096] = "";
						snprintf(szBuf, 8096,
							lang.getString("ModRemoveTechConfirm").c_str(),
							selectedTechName.c_str());
						showMessageBox(szBuf, lang.getString("Question"), true);
					} else {
						mainMessageBoxState = ftpmsg_None;
						...
						char szBuf[8096] = "";
						snprintf(szBuf, 8096,
							lang.getString("ModCannotRemoveTechNotInstalled").
					...
					showMessageBox(lang.getString("ModSelectTechToRemove"),
						lang.getString("Notice"), true);
				}
			}
				...
				if (selectedTilesetName != "") {
					bool alreadyHasTileset =
						(std::
							find(tilesetFiles.begin(), tilesetFiles.end(),
								selectedTilesetName) != tilesetFiles.end());
					...
					mainMessageBoxState = ftpmsg_None;
					mainMessageBox.init(lang.getString("Ok"), 450);
					showMessageBox(lang.getString("ModSelectTilesetToInstall"),
						lang.getString("Notice"), true);
				}
				...
				if (selectedTilesetName != "") {
					...
					if (alreadyHasTileset == true) {
						...
						char szBuf[8096] = "";
						snprintf(szBuf, 8096,
							lang.getString("ModRemoveTilesetConfirm").c_str(),
							selectedTilesetName.c_str());
						showMessageBox(szBuf, lang.getString("Question"), true);
					} else {
						mainMessageBoxState = ftpmsg_None;
						...
						char szBuf[8096] = "";
						snprintf(szBuf, 8096,
							lang.getString("ModCannotRemoveTilesetNotInstalled").
							c_str(), selectedTilesetName.c_str());
						showMessageBox(szBuf, lang.getString("Notice"), true);
					}
				} else {
					mainMessageBoxState = ftpmsg_None;
					mainMessageBox.init(lang.getString("Ok"), 450);
					showMessageBox(lang.getString("ModSelectTilesetToRemove"),
						lang.getString("Notice"), true);
				}
			}
				...
				if (selectedMapName != "") {
					bool alreadyHasMap =
						(std::
							find(mapFiles.begin(), mapFiles.end(),
								selectedMapName) != mapFiles.end());
					...
					mainMessageBoxState = ftpmsg_None;
					mainMessageBox.init(lang.getString("Ok"), 450);
					showMessageBox(lang.getString("ModSelectMapToInstall"),
						lang.getString("Notice"), true);
				}
				...
				if (selectedMapName != "") {
					...
					if (alreadyHasMap == true) {
						...
						char szBuf[8096] = "";
						snprintf(szBuf, 8096,
							lang.getString("ModRemoveMapConfirm").c_str(),
							selectedMapName.c_str());
						showMessageBox(szBuf, lang.getString("Question"), true);
					} else {
						mainMessageBoxState = ftpmsg_None;
						...
						char szBuf[8096] = "";
						snprintf(szBuf, 8096,
							lang.getString("ModCannotRemoveMapNotInstalled").
							c_str(), selectedMapName.c_str());
						showMessageBox(szBuf, lang.getString("Notice"), true);
					}
				} else {
					mainMessageBoxState = ftpmsg_None;
					mainMessageBox.init(lang.getString("Ok"), 450);
					showMessageBox(lang.getString("ModSelectMapToRemove"),
						lang.getString("Notice"), true);
				}
			}
				...
				if (selectedScenarioName != "") {
					bool alreadyHasScenario =
						(std::
							find(scenarioFiles.begin(), scenarioFiles.end(),
								selectedScenarioName) != scenarioFiles.end());
					...
					mainMessageBoxState = ftpmsg_None;
					mainMessageBox.init(lang.getString("Ok"), 450);
					showMessageBox(lang.getString("ModSelectScenarioToInstall"),
						lang.getString("Notice"), true);
				}
				...
				if (selectedScenarioName != "") {
					...
					if (alreadyHasScenario == true) {
						...
						char szBuf[8096] = "";
						snprintf(szBuf, 8096,
							lang.getString("ModRemoveScenarioConfirm").c_str(),
							selectedScenarioName.c_str());
						showMessageBox(szBuf, lang.getString("Question"), true);
					} else {
						mainMessageBoxState = ftpmsg_None;
						...
						char szBuf[8096] = "";
						snprintf(szBuf, 8096,
							lang.getString("ModCannotRemoveScenarioNotInstalled").
							c_str(), selectedScenarioName.c_str());
						showMessageBox(szBuf, lang.getString("Notice"), true);
					}
				} else {
					mainMessageBoxState = ftpmsg_None;
					mainMessageBox.init(lang.getString("Ok"), 450);
					showMessageBox(lang.getString("ModSelectScenarioToRemove"),
						lang.getString("Notice"), true);
				}
			}
				...
				if (keyMapScrollBar.getElementCount() != 0) {
					for (int i = keyMapScrollBar.getVisibleStart();
						...
						if (keyMapButtons[i]->mouseClick(x, y)
							&& keyMapButtons[i]->getEnabled()) {
				...
				if (keyTechScrollBar.getElementCount() != 0) {
					for (int i = keyTechScrollBar.getVisibleStart();
						...
						if (keyTechButtons[i]->mouseClick(x, y)
							&& keyTechButtons[i]->getEnabled()) {
				...
				if (keyTilesetScrollBar.getElementCount() != 0) {
					for (int i = keyTilesetScrollBar.getVisibleStart();
						...
						if (keyTilesetButtons[i]->mouseClick(x, y)
							&& keyTilesetButtons[i]->getEnabled()) {
							...
							if (tilesetName != "") {
								...
								bool remoteHasTileset =
									(tilesetCacheList.find(tilesetName) !=
										tilesetCacheList.end());
								if (remoteHasTileset) {
				...
				if (keyScenarioScrollBar.getElementCount() != 0) {
					for (int i = keyScenarioScrollBar.getVisibleStart();
						...
						if (keyScenarioButtons[i]->mouseClick(x, y)
							&& keyScenarioButtons[i]->getEnabled()) {
			...
			if (modInfo->imageUrl != "") {
				...
				if (tempImage != "" && fileExists(tempImage) == false) {
					...
					if (ftpClientThread != NULL
						&& ftpClientThread->getProgressMutex() != NULL)
						ftpClientThread->getProgressMutex()->setOwnerId(mutexOwnerId);
					if (fileFTPProgressList.find(tempImage) ==
						fileFTPProgressList.end()) {
		...
		void MenuStateMods::cleanupPreviewTexture() {
			if (SystemFlags::VERBOSE_MODE_ENABLED)
				printf("In [%s::%s Line: %d] scenarioLogoTexture [%p]\n", __FILE__,
					__FUNCTION__, __LINE__, modPreviewImage);

			if (modPreviewImage != NULL) {
				Renderer::getInstance().endTexture(rsGlobal, modPreviewImage,
					false);
			}
			modPreviewImage = NULL;
		}
		...
		void MenuStateMods::render() {
			try {
				...
				if (modInfoSelected != NULL) {
					...
					if (displayModPreviewImage.find(tempImage) !=
						displayModPreviewImage.end()
						&& displayModPreviewImage[tempImage] == true) {
						if (modPreviewImage == NULL) {
							string tempImage = getPreviewImageFileForMod(modInfoSelected);
							...
							if (SystemFlags::VERBOSE_MODE_ENABLED)
								printf
								("### Render tempImage [%s] fileExists(tempImage) = %d\n",
				...
				if (keyTechScrollBar.getElementCount() != 0) {
					for (int i = keyTechScrollBar.getVisibleStart();
						...
						bool alreadyHasTech =
							(std::
								find(techTreeFiles.begin(), techTreeFiles.end(),
									keyTechButtons[i]->getText()) != techTreeFiles.end());
						if (keyTechButtons[i]->getText() == selectedTechName) {
							bool lightedOverride = true;
							renderer.renderButton(keyTechButtons[i], &WHITE,
								&lightedOverride);
							...
							Vec4f fontColor =
								Vec4f(200.0f / 255.0f, 187.0f / 255.0f, 190.0f / 255.0f,
									0.75f);
				...
				if (keyTilesetScrollBar.getElementCount() != 0) {
					for (int i = keyTilesetScrollBar.getVisibleStart();
						...
						bool alreadyHasTileset =
							(std::
								find(tilesetFiles.begin(), tilesetFiles.end(),
									keyTilesetButtons[i]->getText()) !=
								tilesetFiles.end());
						if (keyTilesetButtons[i]->getText() == selectedTilesetName) {
							bool lightedOverride = true;
							renderer.renderButton(keyTilesetButtons[i], &WHITE,
								&lightedOverride);
				...
				if (keyMapScrollBar.getElementCount() != 0) {
					for (int i = keyMapScrollBar.getVisibleStart();
						...
						bool alreadyHasMap =
							(std::
								find(mapFiles.begin(), mapFiles.end(),
									mapNameToRender) != mapFiles.end());
						if (keyMapButtons[i]->getText() == selectedMapName) {
							bool lightedOverride = true;
							renderer.renderButton(keyMapButtons[i], &WHITE,
								&lightedOverride);
				...
				if (keyScenarioScrollBar.getElementCount() != 0) {
					for (int i = keyScenarioScrollBar.getVisibleStart();
						...
						bool alreadyHasScenario =
							(std::
								find(scenarioFiles.begin(), scenarioFiles.end(),
									keyScenarioButtons[i]->getText()) !=
								scenarioFiles.end());

						if (keyScenarioButtons[i]->getText() == selectedScenarioName) {
							bool lightedOverride = true;
							renderer.renderButton(keyScenarioButtons[i], &WHITE,
								&lightedOverride);
				...
				if (fileFTPProgressList.empty() == false) {
					...
					for (std::map < string, pair < int, string > >::iterator iterMap =
						fileFTPProgressList.begin();
						iterMap != fileFTPProgressList.end(); ++iterMap) {

						string progressLabelPrefix =
							lang.getString("ModDownloading") + " " +
							extractFileFromDirectoryPath(iterMap->first) + " ";
						//if(SystemFlags::VERBOSE_MODE_ENABLED) printf("\nRendering file progress with the following prefix [%s]\n",progressLabelPrefix.c_str());

						if (Renderer::renderText3DEnabled) {
							renderer.renderProgressBar3D(iterMap->second.first,
								//10,
								//yLocation,
								xLocation,
								yLocation,
								CoreData::getInstance().
								getDisplayFontSmall3D(), 185,
								progressLabelPrefix, false);
						} else {
							renderer.renderProgressBar(iterMap->second.first,
								//10,
								//yLocation,
								xLocation,
								yLocation,
								CoreData::getInstance().
								getDisplayFontSmall(), 185,
								progressLabelPrefix, false);
						}
				...
				if (validMapPreview) {
					...
					if (enableMapPreview && (mapPreview.hasFileLoaded() == true)) {
						...
						if (mapPreviewTexture == NULL) {
							...
							renderer.renderMapPreview(&mapPreview, true, 10, 350,
								&mapPreviewTexture);
						}
					}
				}
			...
			if (keyTechScrollBar.getElementCount() != 0) {
				for (int i = keyTechScrollBar.getVisibleStart();
					...
					keyTechButtons[i]->setY(keyButtonsYBase - keyButtonsLineHeight * (i
						...
						getVisibleStart
						()));
					labelsTech[i]->setY(keyButtonsYBase -
			...
			if (keyMapScrollBar.getElementCount() != 0) {
				for (int i = keyMapScrollBar.getVisibleStart();
					...
					keyMapButtons[i]->setY(keyButtonsYBase - keyButtonsLineHeight * (i
						...
						getVisibleStart
						()));
					labelsMap[i]->setY(keyButtonsYBase -
						keyButtonsLineHeight * (i -
							keyMapScrollBar.
							getVisibleStart()));
				}
		...
		void MenuStateMods::showMessageBox(const string & text,
		...
		void MenuStateMods::FTPClient_CallbackEvent(string itemName,
			...
			if (type == ftp_cct_DownloadProgress) {
				...
				if (result.first == ftp_crt_SUCCESS) {
					...
					char szBuf[8096] = "";
					snprintf(szBuf, 8096,
						lang.getString("ModDownloadMapSuccess").c_str(),
						itemName.c_str());
					console.addLine(szBuf, true);
				} else {
					...
					char szBuf[8096] = "";
					snprintf(szBuf, 8096,
						lang.getString("ModDownloadMapFail").c_str(),
						itemName.c_str(), curlVersion->version,
						result.second.c_str());
					console.addLine(szBuf, true);
				}
				...
				if (result.first == ftp_crt_SUCCESS) {
					...
					char szBuf[8096] = "";
					snprintf(szBuf, 8096,
						lang.getString("ModDownloadTilesetSuccess").c_str(),
						itemName.c_str());
					console.addLine(szBuf, true);
					// END
				} else {
					...
					char szBuf[8096] = "";
					snprintf(szBuf, 8096,
						lang.getString("ModDownloadTilesetFail").c_str(),
						itemName.c_str(), curlVersion->version,
						result.second.c_str());
					console.addLine(szBuf, true);
				}
				...
				if (result.first == ftp_crt_SUCCESS) {
					...
					char szBuf[8096] = "";
					snprintf(szBuf, 8096,
						lang.getString("ModDownloadTechSuccess").c_str(),
						itemName.c_str());
					console.addLine(szBuf, true);
					...
					char szBuf[8096] = "";
					snprintf(szBuf, 8096,
						lang.getString("ModDownloadTechFail").c_str(),
						itemName.c_str(), curlVersion->version,
						result.second.c_str());
					console.addLine(szBuf, true);
				}
				...
				if (result.first == ftp_crt_SUCCESS) {
					char szBuf[8096] = "";
					snprintf(szBuf, 8096,
						lang.getString("ModDownloadScenarioSuccess").c_str(),
						itemName.c_str());
					console.addLine(szBuf, true);
					...
					char szBuf[8096] = "";
					snprintf(szBuf, 8096,
						lang.getString("ModDownloadScenarioFail").c_str(),
						itemName.c_str(), curlVersion->version,
						result.second.c_str());
					console.addLine(szBuf, true);
				}
